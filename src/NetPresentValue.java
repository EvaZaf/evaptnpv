...
public class NetPresentValue extends javax.swing.JFrame {
	...
	jSeparator7.setVisible(false);
        ...
        jButton2.setBackground(new java.awt.Color(37, 34, 34));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            for(int i=0;i<k-1;i++){//or i=1
                athroisma+=Double.parseDouble(list.get(i).getText())/Math.pow((1+result1),i+2);//or i+1
                System.out.println(Math.pow((1+result1),i+2));//or i+1
            }
            ...
            if(Double.parseDouble(result.getText())> 0){
                JOptionPane.showMessageDialog(null, "Succesful! You will have "+result+" gain.");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //-----------------------------------------------------//
        select w=new select();//δημιουργια αντικειμενου deuteri_selida
		w.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NetPresentValue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
		//---------------------------------------------------------//
	NetPresentValue npv = new NetPresentValue();//Δήλωση window
	npv.setSize(900,600);//Customize size για το μέγεθος παραθύρου
	npv.setResizable(false);//Απενεργοποίηση Maximize στο παράθυρο
		
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                npv.setVisible(true);//customize		new NetPresentValue().setVisible(true);
            }
        });
    }
