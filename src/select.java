...
public class select extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setBackground(new java.awt.Color(37, 34, 34));
        ...
        jLabel7.setText("Περιόδου Επανείσπραξης");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NetPresentValue npv=new NetPresentValue();//δημιουργια αντικειμενου NetPresentValue
        npv.setSize(900,600);
        npv.setVisible(true);
        dispose();
