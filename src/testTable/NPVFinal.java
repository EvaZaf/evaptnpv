...
//import static loginTest.username;
 
public class NPVFinal extends javax.swing.JFrame{

    /**
     * Creates new form NVPFinal
     */
    //login Login;
...
//insert data into db  
	...
	// String loginuser;
    public NPVFinal() throws SQLException {//String user
       ...
       con=SqlConnect.ConnectDB();
        ...
        //arxkostos.setText(user);
    }
    //new constructor
    public NPVFinal(User user){//apo User.java
        this.setResizable(false);
        username=user.getUsername();
        initComponents();
        
    }
    /*public NPVFinal(String LoginUser) throws SQLException {   
  ...
  //  }
    ...
    //constructor for username login
    /*NPVFinal(String u) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }*/
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            result.setText(String.valueOf(athroisma-Double.parseDouble(kostos)));
             ...
             int dialogResult = JOptionPane.showConfirmDialog (null, "Would You Like to Save your Previous Results?","Warning",dialogButton);
            ...
            String valueQuery="INSERT INTO values (arxkostos,epitokio, kerdos, etos2, etos3, etos4,etos5, etos6, etos7, result) VALUES (?,?,?,?,?,?,?,?,?,?) ";
            System.out.println("Before pst valueQuery\n");
            values=con.prepareStatement(valueQuery);
            System.out.println("AFTER pst valueQuery\n");
            //pst.executeUpdate();
            System.out.println("After pst.executeUpdate in valueQuery\n");
            values.setString(1,arxkostos.getText());
            values.setString(2, jTextField1.getText());
            values.setString(3,kerdos.getText());
            //values.setString(4,jTextField3.getText());
            //values.setString(5,jTextField4.getText());
            //values.setString(6,jTextField5.getText());
            //values.setString(7,jTextField6.getText());
           // values.setString(8,jTextField7.getText());
            //values.setString(9, jTextField8.getText());
            values.setString(10, result.getText());
            ...
            *///details
            ...
            //String npvquery = "insert into dataResults (username, result) values (?, ?)";
             //String kk = "dsdf";
             
           //String npvquery="INSERT INTO results (id,username,result) VALUES (?,?,?) ";//     (2,'"+this.username+"','"+result.getText())+"')
           //String npvquery="INSERT INTO results (id,username,result) VALUES (?,?,?) ";
           //String npvquery="INSERT INTO Users_Result (username,result) VALUES (?,?) ";
           ...
           //int id=1;
          // npv.setString(1,id);
           //pst.setInt(1,66);//for table results
           //pst.setString(2,"L");//  "ggg" OR loginuser       L.toString().lastIndexOf
           //System.out.println("mphke");
           //pst.setString(2,username);//for table results//String.valueOf(username)   username OR  "test" OR  username.toString()  "jsjsjsj"  OR  this.username
           //pst.setString(3, result.getText());//for table results
          ...
          // id+=1;
           ...
           // DefaultTableModel model=jTableResults.getModel(); //new DefaultTableModel();
    ...
    public static void main(String args[]) throws SQLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NPVFinal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        npv.setSize(875,590);//Customize size για το μέγεθος παραθύρου
	//npv.setResizable(false);
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                npv.setVisible(true);//new NVPFinal()
            }
        });
    }
